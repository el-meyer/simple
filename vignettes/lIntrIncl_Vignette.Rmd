...
Global variables are inputs that are used in different modules and change during the simulation. The current time could be an example for a variable of interest for which it makes sense to be globally available. Another global variable could be the in-trial-time of interventions.
