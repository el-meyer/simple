...
The snapshot variables saved in the list *lPltfTrial* have a fixed name which can not be changed as it is implemented in many different modules. As mentioned above the vignette of the module *lPltfTrial* will contain an overview of all the snapshot variables used in any module.
